...
with sql3.connect("users.db") as db:
    cursor = db.cursor()
...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='black', bg='#ff6347', font='Calibri 20 bold underline')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='#68228B', bg='#BCEE68', command=self.generate_password)
